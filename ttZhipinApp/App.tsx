...
import OnlineResumeEditPage from './src/pages/worker/onlineResume/OnlineResumeEditPage';
    ...
    <SafeAreaProvider>
      ...
      <NavigationContainer>
        <Stack.Navigator initialRouteName='SplashPage'>
          ...
          <Stack.Screen options={{headerShown: false}} name='OnlineResumeEditPage' component={OnlineResumeEditPage}/>
